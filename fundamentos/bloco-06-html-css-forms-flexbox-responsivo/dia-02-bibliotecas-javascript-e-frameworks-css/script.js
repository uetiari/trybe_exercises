...
new window.JustValidate('form', {
  Messages: {
    ...
    maxLength: `The field must contain a maximum of ${maxLength} characters`,
    minLength: `The field must contain a minimum of ${maxLength} characters`,
